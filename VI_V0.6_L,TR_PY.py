...
def download_and_copy_to_folder():
    files_to_download = [
        {'url': 'https://raw.githubusercontent.com/murat725178252/VoiderInstaller/main/VoiderV0-6/Voider.py', 'save_path': 'Voider.py'},
        {'url': 'https://raw.githubusercontent.com/murat725178252/VoiderInstaller/main/VoiderV0-6/logo.png', 'save_path': 'logo.png'}
    ]
